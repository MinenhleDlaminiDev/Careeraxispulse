    ...
    <>
      ...
      <section style={{ background: "linear-gradient(180deg,#0E1830 0%,#1E3054 100%)", color: "#F4EFE4", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: "1240px", margin: "0 auto", padding: "28px 32px 84px", position: "relative", textAlign: "center", animation: "fadeUp .7s ease both" }}>
          ...
          <p style={{ fontSize: "18px", lineHeight: "1.65", color: "#B9C0D2", maxWidth: "580px", margin: "24px auto 38px" }}>CareerPulse Axis strengthens workforce competitiveness through research-informed employability systems encompassing professional CV writing, professional readiness, strategic career development and workforce positioning. Our approach translates labour market intelligence into strategic career solutions that expand access to opportunities across national and global labour markets.</p>
          <div style={{ display: "flex", gap: "14px", flexWrap: "wrap", justifyContent: "center" }}>
            <a href="/services#cv" style={{ background: "#C9A227", color: "#131F38", padding: "16px 30px", borderRadius: "3px", fontWeight: "600", fontSize: "15.5px" }} data-h="hv-home-0">Book a CV Revamp from R150</a>
            <a href="/xislab" style={{ border: "1px solid #3C4B6E", color: "#F4EFE4", padding: "16px 30px", borderRadius: "3px", fontWeight: "600", fontSize: "15.5px" }} data-h="hv-home-1">Join XisLab at R199/mo</a>
          </div>
      ...
      <section style={{ maxWidth: "1240px", margin: "0 auto", padding: "100px 32px 90px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: "32px 64px", marginBottom: "64px", alignItems: "end" }}>
          ...
          <p style={{ fontSize: "16px", color: "#56607A", lineHeight: "1.7", margin: "0", maxWidth: "520px", justifySelf: "end" }}>Every service follows a clear, intentional process, with no templates and no guesswork. Priced for the South African market, from graduate to executive.</p>
        </div>
        ...
        <div style={{ maxWidth: "1240px", margin: "0 auto", padding: "92px 32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: "56px" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "14.5px", lineHeight: "1.65", color: "#56607A", margin: "0" }}>Career positioning is ongoing, so loyal clients pay less every time they come back.</p>
            </div>
          </div>
        </div>
      </section>
